...
public class TestRecTrap {

	public static void main(String[] args) {
		Random rand = new Random();
		int length = 1 + rand.nextInt(10);
		int width = 1 + rand.nextInt(10);
		Rectangle rec1 = new Rectangle(length, width, width);
		length = 1 + rand.nextInt(10);
		width = 1 + rand.nextInt(10);
		Rectangle rec2 = new Rectangle(length, width, width);
		...
		System.out.println("Are the rectangles equal? " + rec1.equals(rec2));

		System.out.println(trap1.toString());
		System.out.println(trap2.toString());

		System.out.println("Are the trapezoids equal? " + trap1.equals(trap2));
